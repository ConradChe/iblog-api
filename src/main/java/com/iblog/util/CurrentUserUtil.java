...
public class CurrentUserUtil {
	 ...
	 * @return
	 */
	public static String getOpenId(Map params) {
		return params.get("session.open_id").toString();
	}
	/**
	 * 获取SessionKey
	 * @param params
	 * @return
	 */
	public static String getSessionKey(Map params) {
		return params.get("session.sessionKey").toString();
	}
}
